...
//   console.log(hello, printGreeting);
// };
...
// let printFarewell = (name) => {
//   let names = `bye, it was nice meeting ${name}`;
//   console.log(names);
// };
// printFarewell("susan");
...
//   let age = currentYear - birthYear; // Calculates the age
//   console.log(`Your age is ${age}.`); // Prints the calculated age
// };

// calculateAge(1986);

// let calculateAge = (birthYear) => {
//   let age = `hey, whats your ${birthYear}?`;
...
let convertTemperature = (celsius) => {
  ...
  return `the temprature is ${fahrenheit}`;
};

console.log(convertTemperature(39));
